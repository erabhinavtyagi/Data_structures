...
main ()
{
  ...
  while(choice!=4)
  {
  printf("OPERATIONS:\n 1: Create linked list\n 2: Delete Starting node from List\n 3: Display List\n 4: Exit\n");
...
void delete_startnode()
{
	...
	{
		temp =head;					// Address of Head copied to temporary node.
		head =head->next;				// Link head to second node
	
		printf("Deleted %d\n",temp->data);		// Data of node to be deleted.
		free(temp);
